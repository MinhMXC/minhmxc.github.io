...
function BadAppleShowcase() {
    return (
        <div className="proj_container">
            <iframe width="850" height="480" src="https://www.youtube.com/embed/PulU7kVTtDY?si=UIPMboCNExcXSmA0"
...
function MinecraftShowcase() {
    return (
        <div className="proj_container">
            <iframe width="850" height="480" src="https://www.youtube.com/embed/A7Pq-aBa_NU?si=RoslQ5lOLw65IeRG"
                    title="YouTube video player" frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
